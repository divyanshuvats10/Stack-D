const PizzaCard = ({ pizza, onAdd }) => {
  return (
    <article className="group overflow-hidden rounded-[1.5rem] border border-line bg-paper shadow-[0_12px_35px_rgba(52,39,29,0.06)] transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_18px_45px_rgba(52,39,29,0.12)]">
